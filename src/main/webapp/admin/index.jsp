		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="card paint-card">
					<div class="card-body text-center text-dark">
						...
						<p class="fs-4 text-center">
							Total Appointment <br><%=dbo.countAppointment()%>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4 mt-4">
				 ...
				 <div class="card paint-card " data-bs-toggle="modal"
					...
					<div class="card-body text-center text-dark">
						<i class="fa-sharp fa-solid fa-user-doctor fa-3x"></i><br>
						<p class="fs-4 text-center">
							Specialist <br><%=dbo.countSpecialist()%>
						</p>
					</div>
				</div>
