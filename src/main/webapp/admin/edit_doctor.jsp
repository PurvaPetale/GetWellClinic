			...
			<div class="col-md-4 offset-md-4">
				<div class="card paint-card">
					<div class="card-body">
						...
						Doctor d = dbo2.getDoctorById(id);
						%>
						...
						<form action="../updateDoctor" method="post">
							...
							<div class="mb-3">
								<label class="form-label">Specialist</label> <select name="spec"
									...
									List<Specialist> list = dbo.getAllSpecialist();
							...
							<div class="mb-3">
								<label class="form-label">Age</label> <input required name="age"
									type="text" class="form-control" value="<%=d.getAge()%>">
							</div>

							<div class="mb-3">
								<label class="form-label">Years of Experience</label> <input
									required name="yearofex" type="text" class="form-control"
									value="<%=d.getYearsOfEx()%>">
							</div>
